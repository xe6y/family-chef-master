...
class AppTheme {
  ...
  // ---------------------------------------------------------------------------
  static const Color primary = Color(0xFFD19A6A); // Soft Amber (default)
  static const Color onPrimary = Color(0xFFFFFFFF);
  static const Color secondary = Color(0xFFF3EEE7); // Warm Oat
  static const Color tertiary = Color(0xFF8FA88D); // Sage Green
  static const Color surface = Color(0xFFFFFFFF);
  static const Color outline = Color(0xFFE1DBD2);
  ...
  // Extended accents (for tags, badges, highlights)
  static const Color accentSky = Color(0xFF8FB3D9);
  static const Color accentMint = Color(0xFF7DB7A3);
  static const Color accentAmber = Color(0xFFF2C27A);
  static const Color accentRose = Color(0xFFE5A2A2);
  static const Color accentSlate = Color(0xFF8FA3A9);

  // Semantic colors
  static const Color success = Color(0xFF6FB18A);
  static const Color warning = Color(0xFFF2B45B);
  static const Color info = Color(0xFF7FAED6);
  static const Color danger = Color(0xFFE07B7B);
